        ...
        <div className="bg-white rounded-3xl shadow-xl border border-coffee-100 p-8 sm:p-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <textarea name="notes" rows={3} placeholder="Estimated monthly consumption..." className="w-full bg-coffee-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-gold-500" />
            </div>
